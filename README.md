...
Желаемый срок выполнения: до 27.07.2015 в 23.59.
Максимальный срок выполнения: до 31.07.2015 в 23.59.

Результаты предоставить в виде архива с исходными текстами (или в виде ссылки на публичный репозиторий в github).
